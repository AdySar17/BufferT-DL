...
(function () {
  ...
  const T = {
    ...
    sub_new_type_classic_desc: { es:'Va a Demon List.', en:'Goes to Demon List.', ru:'Попадает в Demon List.', pt:'Vai para a Demon List.', fr:'Va dans la Demon List.', vi:'Vào Demon List.' },
     sub_new_type_platformer_desc: { es:'Va a PemonList y usa Plataforma.', en:'Goes to PemonList and uses Platform.', ru:'Попадает в PemonList и использует Платформу.', pt:'Vai para a PemonList e usa Plataforma.', fr:'Va dans PemonList et utilise la Plateforme.', vi:'Vào PemonList và dùng Nền tảng.' },
    ...
    sub_list_platform: { es:'Plataforma', en:'Platform', ru:'Платформа', pt:'Plataforma', fr:'Plateforme', vi:'Nền tảng' },
    ...
    profile_ranking:      { es:'Ranking', en:'Ranking', ru:'Рейтинг', pt:'Ranking', fr:'Classement', vi:'Xếp hạng' },
     profile_ranking_classic:{ es:'RANKING CLASSIC', en:'CLASSIC RANKING', ru:'КЛАССИЧЕСКИЙ РЕЙТИНГ', pt:'RANKING CLASSIC', fr:'CLASSEMENT CLASSIQUE', vi:'XẾP HẠNG CLASSIC' },
